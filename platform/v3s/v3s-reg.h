...
typedef struct {
  ...
  __IO  u32 RES4;
  __IO  u32 PLL_PERIPH0_CTRL;// 0x28 PLL_PERIPH Control Register
  __IO  u32 RES5[9];
...
#define PA  ((PIO_T*)0x01C20800) /* GPIO_A */
#define PB  ((PIO_T*)0x01C20824) /* GPIO_B */
#define PC  ((PIO_T*)0x01C20848) /* GPIO_C */
#define PD  ((PIO_T*)0x01C2086C) /* GPIO_D */
#define PE  ((PIO_T*)0x01C20890) /* GPIO_E */
#define PF  ((PIO_T*)0x01C208B4) /* GPIO_F */
#define PG  ((PIO_T*)0x01C208D8) /* GPIO_G */
#define PH  ((PIO_T*)0x01C208FC) /* GPIO_H */
#define PI  ((PIO_T*)0x01C20920) /* GPIO_I */
#define PL  ((PIO_T*)0x01F02C00) /* GPIO_L */
