#ifndef _SSD202D_GPIO_H__
#define _SSD202D_GPIO_H__
...
#define REG8(addr)                 (*(volatile uint8_t*)(MMIO_BASE + (((addr) & ~1)<<1) + (addr & 1)))

#define ADDR_REG8(addr)                 ((MMIO_BASE + (((addr) & ~1)<<1) + (addr & 1)))
