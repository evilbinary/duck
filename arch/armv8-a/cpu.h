...
#define dsb() asm volatile("dsb ish\n")
...
#define syscall2(syscall_num, arg1, arg2)  1     
//  \
  // ({                                             \
  //   int ret;                                     \
  //   asm volatile(                                \
...
#define syscall3(syscall_num, arg1, arg2, arg3)     1
        // \
  // ({                                                        \
  //   int ret;                                                \
  //   asm volatile(                                           \
...
#define syscall4(syscall_num, arg1, arg2, arg3, arg4)  1
                // \
  // ({                                                                   \
  //   int ret;                                                           \
  //   asm volatile(                                                      \
...
#define syscall5(syscall_num, arg1, arg2, arg3, arg4, arg5)    1        
//  \
  // ({                                                                    \
  //   int ret;                                                            \
  //   asm volatile(                                                       \
